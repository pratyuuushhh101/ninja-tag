...
- `fca371d` `test(phase4.4): add unit and integration acceptance tests for correct input-state simulation semantics`
- `ddf0ea7` `fix(networking): Phase 4.4 correct input-state / simulation semantics`
- `ac6a586` `test(phase4.3): add unit and integration acceptance tests for 60Hz input command model`
- `9a9d854` `feat(client): Phase 4.3 Authoritative 60Hz Input Command Model`
- `de17ba6` `test(phase4.1): add acceptance tests for 60Hz prediction timing and playerIdRef ACK extraction`
- `5f28a64` `fix(client): Phase 4.1 patch for 60Hz prediction timing and playerId closure staleness`
- `ae91f2e` `test(phase4): add unit and integration tests for shared movement, prediction, ACK pruning, and reconciliation`
- `dcffd7f` `feat(client): implement client prediction engine and server reconciliation`
- `9a7d6c5` `feat(shared): extract shared simulatePlayerMovement logic for bit-exact simulation`
